...
public class WSGenerator {
    ...
    private static char[][] wordsInPuzzle(char[][] puzzle, List<String> words) {
        ...
        for (String word : words) {
            int tentatives = 0;  // From a certain number of tries, the code assumes that it is impossible to insert the word
            ...
            while (!fitted) {
                    ...
                    switch (orientation) {
                        case UP:
                            ...
                            for (int i = 0; i < word.length(); i++) {
                                ...
                                if (isPossibleToAdd(point, size, occupiedPoints)) {
                ...
                if (tentatives >= 100) {
                    System.err.printf("ERROR! It is impossible to insert the word %s into this puzzle!\n", word);
                    break;
                }
            }
    ...
    public static boolean isPossibleToAdd(Point point, int size, List<Point> occupiedPoints) {
        return (Validation.pointIsValid(point, size) && !occupiedPoints.contains(point));
    }
