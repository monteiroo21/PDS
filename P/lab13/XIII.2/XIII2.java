...
public class XIII2 {
	...
	private static void question2(PrintStream out) {
		...
		PassengerShip ps1 = new PassengerShip("S199", "Bananeiros", 120);
		PassengerShip ps2 = new PassengerShip("S185", "PDS All aboard", 80);
		PassengerShip ps3 = new PassengerShip("S078", "Costeiro", 25);
		av.add("C02", new CargoShip("S101", "Quebra Molas", 155.5));
		av.add("C11", new CargoShip("S732", "SoPingas", 20.2));
		av.add("C03", new CargoShip("S923", "Madalena", 18.8));
		av.add("P54", ps1);
		...
		ShipOfSmallShips s = new ShipOfSmallShips("S111", "AAA");
		s.add(ps1);
		s.add(ps2);
		out.println(s.getShips());
		s.remove(ps2);
		out.println(s.getShips());
